        ...
        <div
          ...
          <img
            src={
              ...
              `/images/${hire.service.kindOfService
                .replace(/\s/g, "")
                .toLowerCase()}.png`
            }
          ...
          <div className="card-body">
            ...
            <h2 className="card-title">
              {hire.service.name}
              <span className="card-user"> by {hire.user.firstName}</span>
            </h2>
            <div className="card-address">{hire.user.city}</div>
            <div
              className="card-service-description">
              {hire.service.name} Services Starting From ${hire.service.price}{" "}
...
export default MyHiresComponent;
